...
colnames(GoodsData_MaxMin) <- c("country", "year", "MaxMin_Index")
GoodsData_MaxMin$MaxMin_Index <- GoodsData_MaxMin$MaxMin_Index/
  max(GoodsData_MaxMin$MaxMin_Index, na.rm = TRUE)
