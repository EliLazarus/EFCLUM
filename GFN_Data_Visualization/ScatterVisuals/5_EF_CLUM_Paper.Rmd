---
title: 'Tracking Sustainable Development: Ecological Footprint Efficiency by Consumption
  Category'
author:
- affiliation: $^1$UC Berkeley, United States. $^2$Global Footprint Network, United
    States
...
```{r Figure 4, echo=FALSE, eval=FALSE}

plotfunc(EFSDGData11.Services,"SDG Data", "Serivces", SDGIndicatorsDownloaded, 1.5, .5)
```
PLOT HAS AN ERROR RIGHT NOW RE LINE LENGTH/WRAPPINH
...
#library(magrittr)
knitr::kable(AllSDGiList[AllSDGiList$timePeriodStart==2011,1:3], row.names = FALSE) #%>%
